			...
			<div class="row">
				<div class="large-12 columns">
                  ...
                  <div class="post-content">
                     <h1 class="mo-animate" data-animate="fadeInDown">Notícias do ramo</h1>                        
         ...
         <div class="row">
            <div class="large-12 columns">
               <ul class="timeline">
                  ...
                  <li class="mo-animate" data-animate="fadeInDown">
                     <div class="timeline-container">
                        <div class="feature-left">
                           <h4 class="gap" data-top="20" data-bottom="12" style="font-family:Raleway; font-weight:100;">Você já ouviu falar em ovo pasteurizado?</h4> 
                           <p>Este ingrediente é muito usado em indústrias para preparar doces e salgados, mas vem ganhando espaço para quem cozinha bastante em casa...                           </p>
                        </div>
                     </div>
                  ...
                  <!--<li class="mo-animate" data-animate="fadeInDown">
                     <div class="timeline-container">
                        <h4 style="font-family:Raleway; font-weight:100;">Ovo Líquido Pasteurizado • AMAZÔNIA RURAL</h4>
                        <div class="blog-video">      
                           <iframe src="//player.vimeo.com/video/92688138?title=0&amp;byline=0&amp;color=fed019"></iframe>
                        </div>
                     </div>
                     <div class="timeline-footer">
                        <div class="footer-content">
                  ...
                  <li class="mo-animate" data-animate="fadeInDown">
                     <div class="timeline-container">
                        <h5 style="font-family:Raleway; font-weight:100;">Alguma matéria de Rádio</h5>                   
                        <p>Neque porro quisquam qui dolorem ipsum quia dolor amet tempora incidunt et dolore magnam aliquam quaerat</p>
                        <div class="mo-media audio">
                           <audio controls>
                              <source src="media/kolintang.mp3">
                              <source src="media/kolintang.ogg">
                              <source src="media/kolintang.wav">
                           </audio>
                        </div>
                  ...
                  <li class="mo-animate" data-animate="fadeInDown">
                     <div class="timeline-container">
                        <div class="feature-left">
                           <h4 class="gap" data-top="20" data-bottom="12" style="font-family:Raleway; font-weight:100;"><strong>DICA</strong> O Segredo do ovo perfeito</h4> 
                           <p>"Não sabe nem fazer ovo frito". Logo se vê que quem criou o dito popular pode até ter sido cozinheiro, mas não era um perfeccionista</p>
                        </div>
                     </div>
                     <div class="timeline-footer">
                        <div class="footer-content">
                        ...
                        <div class="timeline-social">
                           <a class="button tiny yellow" style=" margin-left:15px; border-radius:5px;" href="noticia001.html">ler matéria</a>
                        </div>
                     </div>
                  </li>-->
