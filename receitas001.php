			...
			<div class="row">
				<div class="large-12 columns">
                  ...
                  <div class="post-content">
                     <h1 class="mo-animate" data-animate="fadeInDown">Quindim</h1>                     <br/><br/>                        
                    <div class="blog-media">                                    <ul class="blog-slide">                                  <li><img src="img/receitas/quindim01.jpg" w alt=""/></li>                                   <li><img src="img/receitas/quindim02.jpg" w alt=""/></li>                                                                                                                     </ul>                      </div>                      <br/><br/>
                     <p class="mo-animate" data-animate="fadeInDown" data-delay="400" style="font-weight:100; font-size:25px; line-height:33px">
                     <strong>ingredientes</strong><br/><br/>                     • 200g de açúcar<br/><br/>                     • 200 ml de leite de coco<br/><br/>                     • 150g de coco ralado (fresco)<br/><br/>                     • 15 gemas São Pedro<br/><br/><br/>                                          <strong>Modo de preparo</strong><br/><br/>                                          Uma tigela coloque o açúcar, o leite de coco, o coco ralado e as gemas, mexa bem até fica um creme. Uma forma redonda unte com margarina e açúcar, coloque o creme na forma e leve para assar em banho Maria por 30 minutos, depois de frio é só desenforme.                     
