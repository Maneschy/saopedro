...
<head>
   ...
   <title>Fazenda São Pedro • Empresas do Grupo</title>
			...
			<div class="row">
				<div class="large-12 columns">
                  ...
                  <div class="post-content">
                     <h1 class="mo-animate" data-animate="fadeInDown">Empresas do Grupo</h1>                        
               ...
               <ul class="pf-container large-block-grid-4 medium-block-grid-4 no-wrap">
                ...
                <li class="web print">
                  <div class="mo-caption effect mo-animate" data-animate="fadeInDown" data-delay="200">
                    <img src="img/fotos/empresas/logo-cimento.jpg" alt="" />
                    <div class="mask"></div>
                    <div class="content">
                      <a class="fancybox preview" href="img/fotos/empresas/logo-cimento.jpg" data-fancybox-group="gallery" title="Cimento Itaú"><i class="icon-search"></i></a>
                    </div>
                  </div>
                ...
                <li class="web print">
                  <div class="mo-caption effect mo-animate" data-animate="fadeInDown" data-delay="400">
                    <img src="img/fotos/empresas/logo-lsm.jpg" alt="" />
                    <div class="mask"></div>
                    <div class="content">
                      <a class="fancybox preview" href="img/fotos/empresas/logo-lsm.jpg" data-fancybox-group="gallery1" title="LSM Distribuidora de Alimentos"><i class="icon-search"></i></a>
                    </div>
                  </div>
                ...
                <li class="web print">
                  <div class="mo-caption effect mo-animate" data-animate="fadeInDown" data-delay="600">
                    <img src="img/fotos/empresas/logo-ferragens.jpg" alt="" />
                    <div class="mask"></div>
                    <div class="content">
                      <a class="fancybox preview" href="img/fotos/empresas/logo-ferragens.jpg" data-fancybox-group="gallery" title="São Pedro Ferragens"><i class="icon-search"></i></a>
                    </div>
                  </div>
                ...
                <li class="web print">
                  <div class="mo-caption effect mo-animate" data-animate="fadeInDown" data-delay="1600">
                    <img src="img/fotos/empresas/logo-navegacao.jpg" alt="" />
                    <div class="mask"></div>
                    <div class="content">
                      <a class="fancybox preview" href="img/fotos/empresas/logo-navegacao.jpg" data-fancybox-group="gallery" title="FH Navegação"><i class="icon-search"></i></a>
                    </div>
                  </div>
