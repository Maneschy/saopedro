...
<head>
   ...
   <title>Fazenda São Pedro • Onde Encontrar</title>
				...
				<div class="row">
					<div class="large-12 columns">
	                  ...
	                  <div class="post-content">
	                     <h1 class="mo-animate" data-animate="fadeInDown">Onde encontrar nossos revendedores</h1>                        
	                  ...
	                  <li class="mo-animate" data-animate="fadeInDown">
	                     <div class="timeline-container">
	                        <div class="feature-left">
	                           <h4 class="gap" data-top="20" data-bottom="12" style="font-family:Raleway; font-weight:100;"> Mercadinho São Leopoldo</h4> 
	                           <p>
	                           
	                           <strong>End:</strong> Av. Floriano Peixoto, 32332 • Zona Leste • Manaus <br/>
	                           <strong>Tel:</strong> (92) 3232-4959 • 98345-0909<br/>
	                     ...
	                     <div class="timeline-footer">
	                        <div class="timeline-social">
	                           <a class="button tiny yellow" style=" margin-left:15px; border-radius:5px;" href="http://www.google.com" target="_blank">ver site</a>
	                        </div>
	                     </div>
	                  </li>
