...
<head>
   ...
   <title>Fazenda São Pedro • Ovos Brancos</title>
		...
		<section class="mo-content">
			<div class="row">
                ...
                <div style="text-align:left;"> <img style="float:left; margin-right:20px; margin-top:-15px;" src="img/produtos/logo-ovos-produtos.png">
                 <!--<a class="button small radius yellow" href="#"> OVOS BRANCOS </a> 
                 <a class="button small radius red" href="ovos-vermelhos.html"> OVOS VERMELHOS </a> 
                 <a class="button small radius red" href="ovos-pasteurizados-gemas.html"> OVOS PASTEURIZADOS </a><br/>--><br/>
