...
<head>
   ...
   <title>Fazenda São Pedro • Pintainha Tipo 02</title>
		...
		<section class="mo-content">
			<div class="row">
                ...
                <div class="large-12 columns">
                  ...
                  <div style="text-align:left;"> <img style="float:left; margin-right:20px; margin-top:-15px;" src="img/logo-incubatorio.jpg">
          ...
          <div class="large-12 columns" style="margin-top:-10px;">
				...
				<div class="large-12 columns">
                    ...
                    <h3>Pintainha tipo 02</h3>                                   
                 		<div class="blog-media">           
                    		<ul class="blog-slide">                          
                        		<li><img src="img/slide/pintos-slide02.jpg" w alt=""/></li>
                     		</ul>
                  		</div>
            	               ...
            	               <ul class="pf-container large-block-grid-4 medium-block-grid-4 no-wrap">
            	                ...
            	                <li class="web print">
            	                  <div class="mo-caption effect mo-animate" data-animate="fadeInDown" data-delay="400">
            	                    <img src="img/produtos/pintos/pinto-escuro01.jpg" alt="" />
            	                    <div class="mask"></div>
            	                    <div class="content">
            	                      <a class="fancybox preview" href="img/produtos/pintos/pinto-escuro01.jpg" data-fancybox-group="home" title="foto estrutura"><i class="icon-search"></i></a>
            	                    </div>
            	                  </div>
            	                ...
            	                <li class="web print">
            	                  <div class="mo-caption effect mo-animate" data-animate="fadeInDown" data-delay="400">
            	                    <img src="img/produtos/pintos/pinto-escuro02.jpg" alt="" />
            	                    <div class="mask"></div>
            	                    <div class="content">
            	                      <a class="fancybox preview" href="img/produtos/pintos/pinto-escuro02.jpg" data-fancybox-group="home" title="foto estrutura"><i class="icon-search"></i></a>
            	                    </div>
            	                  </div>
            	                  <div class="pf-info mo-animate" data-animate="fadeInLeft" data-delay="500">
            	                    <div class="text">
            	                ...
            	                <li class="web print">
            	                  <div class="mo-caption effect mo-animate" data-animate="fadeInDown" data-delay="400">
            	                    <img src="img/produtos/pintos/pinto-escuro03.jpg" alt="" />
            	                    <div class="mask"></div>
            	                    <div class="content">
            	                      <a class="fancybox preview" href="img/produtos/pintos/pinto-escuro03.jpg" data-fancybox-group="home" title="foto estrutura"><i class="icon-search"></i></a>
            	                    </div>
            	                  </div>
            	                  <div class="pf-info mo-animate" data-animate="fadeInLeft" data-delay="500">
            	                    <div class="text">
            	                ...
            	                <li class="web print">
            	                  <div class="mo-caption effect mo-animate" data-animate="fadeInDown" data-delay="400">
            	                    <img src="img/produtos/pintos/pinto-escuro04.jpg" alt="" />
            	                    <div class="mask"></div>
            	                    <div class="content">
            	                      <a class="fancybox preview" href="img/produtos/pintos/pinto-escuro04.jpg" data-fancybox-group="home" title="foto estrutura"><i class="icon-search"></i></a>
            	                    </div>
            	                  </div>
            	                  <div class="pf-info mo-animate" data-animate="fadeInLeft" data-delay="500">
            	                    <div class="text">
